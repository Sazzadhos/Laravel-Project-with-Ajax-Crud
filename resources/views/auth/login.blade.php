...
<div class="d-flex align-items-center justify-content-center ht-100v">
      ...
      <div class="overlay-body bg-black-7 d-flex align-items-center justify-content-center">
        <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 rounded bg-black-6">
          <div class="signin-logo tx-center tx-28 tx-bold tx-white"><span class="tx-normal">[</span> Sazzad <span class="tx-info">Hossain</span> <span class="tx-normal">]</span></div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                ...
                <x-input id="email" class="form-control" placeholder="Enter Email Address" type="email" name="email" :value="old('email')" required autofocus />
            </div>
            <!-- Password -->
          ...
          <div class="mg-t-20 tx-left">Not yet a member? <a href="{{ route('register') }}" class="tx-info">Sign Up</a></div>
        </div><!-- login-wrapper -->
      </div><!-- overlay-body -->
    </div>
@endsection